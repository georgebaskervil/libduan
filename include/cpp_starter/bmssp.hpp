 ...
 *  - We treat “complete” vs “incomplete” implicitly: the caller supplies S (complete set) and a
 * distance vector initialized for sources.
 ...
 *  - This implementation focuses on correctness of the returned boundary B' ≤ B and a candidate set
 * U; performance / theoretical bounds may differ from the paper.
